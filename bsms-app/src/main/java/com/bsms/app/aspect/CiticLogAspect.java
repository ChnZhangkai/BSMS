...
public class CiticLogAspect {
	...
	@Pointcut("within(@com.bsms.app.annotation.CiticLog *)")
	...
	@Pointcut("beanAnnotationWithCiticLog() && publicMethod() && !@annotation(com.bsms.app.annotation.CiticLogExcludeThis)")
